 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jg=5*60,Vg=za("authIdTokenMaxAge")||jg;let So=null;const Wg=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Vg)return;const s=n==null?void 0:n.token;So!==s&&(So=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function kc(t=Ch()){const e=Ja(t,"auth");if(e.isInitialized())return e.getImmediate();const n=_p(t,{popupRedirectResolver:Fg,persistence:[Jp,Up,Tc]}),r=za("authTokenSyncURL");if(r){const i=Wg(r);Np(n,i,()=>i(n.currentUser)),kp(n,o=>i(o))}const s=Va("auth");return s&&yp(n,`http://${s}`),n}Hg("Browser");const zg={class:"py-8 flex justify-between gap-10 text-white"},Kg={class:"flex gap-10 items-center"},qg={class:"hover:-rotate-6 transition-all"},Gg={class:"flex gap-10"},Jg={class:"hover:text-neutral-200 cursor-pointer text-xl"},Yg=ne("span",{class:"hidden md:block"},"Home",-1),Xg={class:"hover:text-neutral-200 cursor-pointer text-xl"},Qg=ne("span",{class:"hidden md:block"},"Search",-1),Zg={class:"hover:text-neutral-200 cursor-pointer text-xl"},em=ne("span",{class:"hidden md:block"},"Watchlist",-1),tm={key:0},nm=ne("span",{class:"hidden md:block"},"Log out",-1),rm=ne("span",{class:"hidden md:block"},"Log In",-1),sm={__name:"Navbar",setup(t){const e=Xo(null),n=cd();let r;da(()=>{r=kc(),bc(r,o=>{o?e.value=!0:e.value=!1})});const s=()=>{n.push("/login")},i=()=>{xp(r).then(()=>{e.value=!1,n.push("/login")}).catch(o=>{alert(o.message)})};return(o,c)=>{const a=ga("router-link");return He(),Ge("header",null,[ne("nav",zg,[ne("div",Kg,[ne("div",qg,[Z(a,{class:"text-2xl cursor-pointer",to:"/"},{default:hn(()=>[Ca("MovieApp")]),_:1})]),ne("ul",Gg,[ne("li",Jg,[Z(a,{to:"/",class:"flex gap-2 items-center"},{default:hn(()=>[Z(Re(tf),{class:"w-5 h-5"}),Yg]),_:1})]),ne("li",Xg,[Z(a,{to:"/search",class:"flex gap-2 items-center"},{default:hn(()=>[Z(Re(nf),{class:"w-5 h-5"}),Qg]),_:1})]),ne("li",Zg,[Z(a,{to:"/watchlist",class:"flex gap-2 items-center"},{default:hn(()=>[Z(Re(rf),{class:"w-5 h-5"}),em]),_:1})])])]),ne("div",null,[e.value===null?(He(),Ge("div",tm,"...")):e.value?(He(),Ge("button",{key:1,onClick:i,class:"button flex"},[Z(Re(Bi),{class:"w-5 h-5"}),nm])):(He(),Ge("button",{key:2,class:"button flex",onClick:s},[Z(Re(Bi),{class:"w-5 h-5"}),rm]))])])])}}},im={__name:"App",setup(t){return(e,n)=>{const r=ga("router-view");return He(),Ge(Fe,null,[Z(sm),Z(r)],64)}}};const om="modulepreload",am=function(t,e){return new URL(t,e).href},Po={},$t=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=am(i,r),i in Po)return;Po[i]=!0;const o=i.endsWith(".css"),c=o?'[rel="stylesheet"]':"";if(!!r)for(let u=s.length-1;u>=0;u--){const h=s[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${c}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":om,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e()).catch(i=>{const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i})},Nc=od({history:Ef(),routes:[{path:"/",component:()=>$t(()=>import("./Home-85fe999a.js"),["./Home-85fe999a.js","./MovieList-cb75b840.js"],import.meta.url)},{path:"/register",component:()=>$t(()=>import("./Register-effc24ef.js"),["./Register-effc24ef.js","./index.esm2017-1e5e2989.js"],import.meta.url)},{path:"/login",component:()=>$t(()=>import("./Login-c8542c70.js"),[],import.meta.url)},{path:"/search",component:()=>$t(()=>import("./Search-d42eb6c4.js"),["./Search-d42eb6c4.js","./MovieList-cb75b840.js"],import.meta.url)},{path:"/:id",name:"movie-details",component:()=>$t(()=>import("./MovieDetails-00d65c48.js"),["./MovieDetails-00d65c48.js","./index.esm2017-1e5e2989.js"],import.meta.url)},{path:"/watchlist",component:()=>$t(()=>import("./Watchlist-ec8b9817.js"),["./Watchlist-ec8b9817.js","./index.esm2017-1e5e2989.js","./MovieList-cb75b840.js"],import.meta.url),meta:{requiresAuth:!0}}]}),cm=()=>new Promise((t,e)=>{const n=bc(kc(),r=>{n(),t(r)},e)});Nc.beforeEach(async(t,e,n)=>{t.matched.some(r=>r.meta.requiresAuth)?await cm()?n():n("/login"):n()});var lm="firebase",um="10.4.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
